...
public class SeniorCitizenLogin extends AppCompatActivity {
  ...
  //  UserOpenHelper mDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvNewAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SeniorCitizenLogin.this, UserRegistration.class);
                startActivity(i);
            }
        });
    ...
    private void init() {
        ...
        Call<Root> responseCall1 = RetrofitClient.getInstance()
                .getInterPreter().SeniorCitizenLogin(email,password);
        responseCall1.enqueue(new Callback<Root>() {
            ...
            public void onResponse(Call<Root> call, Response<Root> response) {
                ...
                if(response1.error)
                {
                    Toast.makeText(SeniorCitizenLogin.this, "Error Occurred...", Toast.LENGTH_LONG).show();
                }
                else{
                    Intent i1 = new Intent(SeniorCitizenLogin.this,SeniorCitizenDashboardActivity.class);
                    i1.putExtra("uid",response1.data.id);
                    i1.putExtra("uname",response1.data.name);
                    i1.putExtra("uemail",response1.data.email);
                    Log.d("SeniorCitizenId", String.valueOf(response1.data.id));
                    startActivity(i1);
                    Toast.makeText(SeniorCitizenLogin.this, "successful",Toast.LENGTH_LONG).show();
                    Toast.makeText(SeniorCitizenLogin.this,""+response1.data.name,Toast.LENGTH_LONG).show();
                }
...
/*
        ...
        if(mDB.checkSeniorCitizen(email,password))
        {

            Intent i1 = new Intent(SeniorCitizenLogin.this,PassSeniorCitizenRequest.class);
            startActivity(i1);

        }
        else{
            Toast.makeText(SeniorCitizenLogin.this,"Not Successful",Toast.LENGTH_LONG).show();
        }
*/
