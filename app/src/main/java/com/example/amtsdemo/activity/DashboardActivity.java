...
public class DashboardActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id== R.id.mPassRequest){
            Intent i1 = new Intent(DashboardActivity.this, Student_PASS_Request.class);
            i1.putExtra("uid",mid);
            i1.putExtra("uname",mUserName);
            i1.putExtra("uemail",mUserEmail);
            startActivity(i1);
            Toast.makeText(DashboardActivity.this, "You Clicked on Student Pass Request", Toast.LENGTH_SHORT).show();
        }
        else if (id == R.id.mMyAccount) {
            Intent i1 = new Intent(DashboardActivity.this, DashboardActivity.class);
            startActivity(i1);
            Toast.makeText(DashboardActivity.this, "You Clicked on My Account", Toast.LENGTH_SHORT).show();
        }
        else if (id == R.id.mSettings) {
            Intent i2 = new Intent(DashboardActivity.this, UpdateProfile.class);
            i2.putExtra("uid",mid);
            startActivity(i2);
            Toast.makeText(DashboardActivity.this, "You Clicked on Settings", Toast.LENGTH_SHORT).show();
        }
        else if(id== R.id.mLogout){
            Intent i2 = new Intent(DashboardActivity.this, MainDashboard.class);
            startActivity(i2);
            Toast.makeText(DashboardActivity.this,"You Clicked on Logout",Toast.LENGTH_LONG).show();
        }
        else if(id==R.id.mPassStatus){
            Intent i1 = new Intent(DashboardActivity.this,BusPassActivity.class);
            i1.putExtra("uid",mid);
            startActivity(i1);
            Toast.makeText(DashboardActivity.this, "You Clicked on Student bus pass status", Toast.LENGTH_SHORT).show();
        }
        return true;
    }
